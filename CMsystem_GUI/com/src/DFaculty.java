...
import javax.swing.*;  
import java.awt.*;
public class DFaculty extends Frame implements ActionListener {
JLabel l19;
JTextField tf6;
JButton b17;
public DFaculty()
...
public void actionPerformed(ActionEvent e)
     {
       ...
       try
      {
       ...
       int x=stmt.executeUpdate("DELETE from faculty where id='"+id+"'");
       if(x==1)
       {
       ...
       {
         JOptionPane.showMessageDialog(b17,"Faculty not found");
       }
       Con.close(); 
